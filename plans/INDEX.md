...
| Plan | Status | Notes |
|------|--------|-------|
| [herdr-agent-harness-research.md](herdr-agent-harness-research.md) | active | Herdr concept research, Draxul terminology alignment, and phased local agent-harness direction; the vocabulary, TabController, and single-default-Space ownership passes are implemented here. |
