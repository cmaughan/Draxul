...
| Plan | Status | Notes |
|------|--------|-------|
| [herdr-agent-harness-research.md](herdr-agent-harness-research.md) | active | Herdr concept research, Draxul terminology alignment, and phased local agent-harness direction; the Workspace-to-Tab, PaneManager, and TabController extraction passes are implemented here. |
