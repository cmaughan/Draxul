...
struct SemanticCityModuleModel
{
    ...
    std::unordered_map<std::string, std::string> function_bundle_remap; // individual fn name → bundle name
    std::unordered_map<std::string, std::string> struct_stack_remap; // individual struct name → stack name
...
struct SemanticMegacityModel
{
    ...
    std::unordered_map<std::string, std::string> function_bundle_remap; // fn qualified_name → bundle qualified_name
    std::unordered_map<std::string, std::string> struct_stack_remap; // struct qualified_name → stack qualified_name
