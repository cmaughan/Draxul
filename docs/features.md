...
| SatView | `--host satview` | Optional 3D satellite-overview host with an interactive texture-mapped Earth, approximate live day/night lighting, left-drag orbit controls, mouse-wheel zoom, and time-speed controls (`Space`, `[`, `]`) |
