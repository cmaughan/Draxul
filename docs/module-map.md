...
| `plugins/rezonality/` | `DRAXUL_ENABLE_REZONALITY` | Submodule → [draxul-rezonality](https://github.com/cmaughan/draxul-rezonality). Fault-tolerant live graphics product ported from VkLive; owns its watched project loader, compiler tools, immutable multipass/model/material candidates, Assimp, cameras, PBR/HDR resources, Vulkan/Metal passes, examples, diagnostics, tests, and remaining product slices |
