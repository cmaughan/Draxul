...
- [ ] Use `WorkspaceController`/HostManager APIs to split or reuse panes according to one documented policy; do not add host-specific branches to `InputDispatcher`.
