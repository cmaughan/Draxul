...
Warn before closing a pane/workspace/session that owns an active foreground job, while allowing clean shells and deliberate force-close.
...
- [ ] Query only on destructive actions and aggregate risks across workspace/session closes.
