...
Existing Chrome UTF-8 layout and text-helper coverage does not exercise the command
palette's independent query buffer and fuzzy-matching path.
...
- [ ] Extend `tests/command_palette_tests.cpp` with multibyte editing coverage.
