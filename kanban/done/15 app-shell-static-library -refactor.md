...
- [x] Compare the same deterministic results on MSVC.
...
- [x] Run App tests and render smoke on MSVC/Vulkan.
...
MSVC App-shell coverage passed in the 48/48 products aggregate. The basic and
panel Vulkan render comparisons and same-cache smoke also passed.
