...
- [x] Verify temperature/emoji formatting and configuration reload on Windows.
...
Windows temperature/emoji formatting and configuration-reload coverage passed
in the final 48/48 products aggregate; same-cache smoke passed.
