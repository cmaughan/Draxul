...
**Dependencies:** Coordinated with `kanban/done/58 plugin-storage-error-preservation -bug.md`; no dependency on another newly accepted refactor. Coordinated source ownership with `kanban/pending/02 host-layer-static-libraries -refactor.md`.
