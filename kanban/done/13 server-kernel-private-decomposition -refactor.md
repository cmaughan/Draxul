...
- [x] Validate the same behavior on Windows.
...
The final products aggregate passed 48/48 with Windows server lifecycle,
publication, terminal, and discovery coverage; same-cache smoke passed.
