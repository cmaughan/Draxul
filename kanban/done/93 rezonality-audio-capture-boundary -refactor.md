...
- [x] Preserve ARC/AVFoundation permissions and Windows SDL/stub behavior.
...
The Windows SDL/stub audio suite and Rezonality render coverage passed in the
final 48/48 products aggregate; same-cache smoke passed. Prior Apple validation
covers the retained ARC/AVFoundation path.
