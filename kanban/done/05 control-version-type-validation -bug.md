...
- [x] Exercise malformed versions through the Windows control transport.
...
The final products aggregate passed 48/48 with malformed versions exercised
through the Windows control transport; same-cache smoke passed.
