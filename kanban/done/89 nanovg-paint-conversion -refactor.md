...
- [x] Build the backend and app on Windows/Vulkan.
...
- [x] Run shared NanoVG and affected product render coverage on Windows/Vulkan.
...
The Windows backend/app build, shared NanoVG comparison, PCBView render, and
refreshed ScoreView render passed; the 48/48 aggregate and smoke also passed.
