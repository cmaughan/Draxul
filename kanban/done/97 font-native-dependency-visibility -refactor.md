...
- [x] Verify MSVC compilation and retained native final links.
- [x] Build affected plugin/font consumers and preserve Metal text rendering.
- [x] Preserve Vulkan text rendering.
...
MSVC compilation and retained native links passed in the final 48/48 products
aggregate. The Unicode Vulkan render comparison and same-cache smoke passed.
