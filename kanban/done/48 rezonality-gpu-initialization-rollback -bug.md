...
- [x] Build the Vulkan backend and run the Rezonality suite on Windows; macOS cannot compile the changed Vulkan resource path.

## Windows closeout (2026-09-22)

The Vulkan Rezonality rollback suite and registered render scenarios passed in
