...
- [x] Validate MSVC behavior on Windows.
...
- [x] Focused and full Windows tests pass under MSVC.
...
MSVC Unicode and consumer coverage passed in the final 48/48 products aggregate;
the Vulkan Unicode render comparison and same-cache smoke passed.
