...
- [x] Check the Windows default directory and durable I/O remain unchanged on Windows.
...
- [x] Windows default paths and durable replacement semantics are verified on Windows.
...
Windows default-path, durable replacement, and dependency-boundary coverage
