...
- [x] Verify corresponding Windows coverage.
...
The project-pipeline and real Rezonality integration coverage passed in the
final 48/48 MSVC/Vulkan products aggregate; same-cache smoke passed.
