...
- [x] Windows: exercise server-owned ConPTY launch, remote presentation, Nvim,
...
`kanban/done/03 nvim-protocol-transport-boundaries -refactor.md`; blocks the
Kanban host split in `kanban/done/04 kanban-core-host-boundary -refactor.md`.

## Windows closeout (2026-09-22)

`py do.py test debug --products` passed 48/48 in 230.53s, including the ConPTY,
remote-presentation, Nvim, and shutdown coverage; same-cache smoke passed.
