...
- [x] Verify Windows Vulkan linking has one VMA implementation.
- [x] Build the macOS app and verify panel/NanoVG rendering on Metal.
- [x] Build the Windows app and verify panel/NanoVG rendering on Vulkan.
...
- [x] Windows Vulkan visuals/linkage remain compatible.
...
The MSVC/Vulkan build retained one VMA implementation. Panel and NanoVG render
comparisons passed, as did the 48/48 products aggregate and same-cache smoke.
