...
- [x] Exercise platform filesystem replacement/error behavior.
- [x] Run `python3 do.py test debug`, then `python3 do.py smoke debug --skip-build`, with Windows equivalents.
...
Windows filesystem replacement/error coverage passed in the final 48/48
