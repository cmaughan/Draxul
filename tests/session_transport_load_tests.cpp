    ...
    const LoadScenario scenario)
{
    ...
    const size_t expected_recurring_requests
        ...
        * scenario.attached_uis;
    const size_t per_channel_equivalent_recurring_requests
        = static_cast<size_t>(kLoadRounds)
        * (scenario.panes + 2 * scenario.attached_uis);
    REQUIRE(expected_recurring_requests
        < per_channel_equivalent_recurring_requests);
    ...
    nlohmann::json result{
        ...
        { "per_channel_equivalent_recurring_requests",
            per_channel_equivalent_recurring_requests },
        { "per_terminal_poll_requests", 0 },
        { "topology_poll_requests", 0 },
        { "agent_poll_requests", 0 },
