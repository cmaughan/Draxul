...
// App-shell split geometry and durable Session-layout projection. Runtime host
// ownership remains in PaneManager; this type stores identifiers and rectangles.
