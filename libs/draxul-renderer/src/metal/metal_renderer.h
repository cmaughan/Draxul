...
private:
    ...
    ObjCRef<id<MTLBuffer>> grid_buffers_[MAX_FRAMES_IN_FLIGHT];
#else
    ...
    void* grid_buffers_[MAX_FRAMES_IN_FLIGHT] = {}; // NOSONAR cpp:S5008
#endif

    size_t atlas_staging_sizes_[MAX_FRAMES_IN_FLIGHT] = {};
    size_t grid_buffer_sizes_[MAX_FRAMES_IN_FLIGHT] = {};
